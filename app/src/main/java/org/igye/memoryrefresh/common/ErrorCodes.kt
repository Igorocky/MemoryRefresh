...
enum class ErrorCode(val code: Long) {
    ...
    TRANSLATION_CARDS_TABLE_UNEXPECTED_NUMBER_OF_INSERTED_ROWS(27L),
    CARDS_TABLE_UNEXPECTED_NUMBER_OF_INSERTED_ROWS(26L),
    CARDS_SCHEDULE_TABLE_UNEXPECTED_NUMBER_OF_INSERTED_ROWS(25L),
